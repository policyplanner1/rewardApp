...
export default function VendorDashboard() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen" style={{ backgroundColor: '#FFFAFB' }}>
        <div className="animate-spin rounded-full h-12 w-12 border-b-2" style={{ borderColor: '#852BAF' }}></div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 space-y-6" style={{ backgroundColor: '#FFFAFB' }}>
      ...
      <div className="rounded-2xl p-6 text-white"
        ...
        <p style={{ color: '#D887FD' }}>Manage your products and track performance</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-xl hover:shadow-2xl transition">
          <div className="flex items-center">
            <div className="p-3 rounded-lg" style={{ backgroundColor: 'rgba(133, 43, 175, 0.15)' }}>
        ...
        <div className="bg-white rounded-xl p-6 shadow-xl hover:shadow-2xl transition">
          <div className="flex items-center">
            <div className="p-3 rounded-lg" style={{ backgroundColor: 'rgba(216, 135, 253, 0.3)' }}>
        ...
        <div className="bg-white rounded-xl p-6 shadow-xl hover:shadow-2xl transition">
          <div className="flex items-center">
            <div className="p-3 rounded-lg" style={{ backgroundColor: 'rgba(252, 63, 120, 0.15)' }}>
              <FaMoneyBillWave className="text-2xl" style={{ color: '#FC3F78' }} />
            </div>
            <div className="ml-4">
